...
-   Envia la lista de tarjeta a emitir en novo
...
3. **Condor**
    ...
    3. Reglas de Integración
        1. **ri_Pedido_Tarjeta_Condor**
			...
			3. Luego hay un mapeo de XML a XML y ejecuta el proceso ri_Validaciones_Pedido_Tarjeta_Condor. Si se ejecuta correctamente sigue al paso 4, sino continua al paso 5.
        ...
        2. **ri_Pedido_Tarjeta_Condor_Archivo**
            1. Validamos si el parametro recibido DPP_INTERFACE es igual a 1 Si es correcto entonces ejecuta el paso 1.1, sino al paso 2.
			    1.1. Entra en un mapeo de datos, de XML a XML y ejecuta el proceso ms_SP_BENEF_ALTAS_INSERTAR.
				1.2. Luego entra en otro mismo mapeo de XML a XML y ejecuta el proceso ms_SP_CAMBIAR_INNOMINADA.
				1.3. Luego envia un mensaje a la cola Cola_Pedido_Tarjeta_Condor_Archivo
        ...
        4. **ri_Pedido_Tarjeta_Masivo_New**
			...
			6. Tambien ejecutamos el proceso CONDOR.PKG_WSSERVICIO.SP_INSERTAR_PETICIONFALLIDA.
			7. Validamos la respuesta del proceso anterior.
				-   si es correcta, entonces ejecuta el proceso de envio de correo que es smtp.gmail.com, puerto 465, usuario busserviciossodexocolombia@gmail.com y contraseña encriptada. El destinatario es busserviciossodexocolombia@gmail.com, remitente es luiscarlos.antequerapena@sodexo.com, subject Prueba correo y un contenido txt/html.
